<?php
//000000000000s:17232:"<script src="/public/js/viewer/viewer.min.js"></script>
...
<div class="people-comment">
    <div class="deta-descri p">
        ...
        <div class="person-com">
            ...
            <div class="lifr4 comfis p">
                <span class="faisf">dsfasfsadfasdfsa</span>
            </div>
            <!--晒单图-->
            <div class="lifr4 requiimg p">
                <ul class="comment_images" id="comment_images_331">
                                            <a><li><img data-original="/public/upload/comment/2017/01-20/588183ad67ef1.jpg" src="/public/upload/comment/2017/01-20/588183ad67ef1.jpg"/></li></a>
                                    </ul>
                <script>
                    var viewer = new Viewer(document.getElementById('comment_images_331'), {
                        url: 'data-original',
                        show: function() {
                            $('.soubao-sidebar').hide();
                        },
            ...
            <div class="lifr4 bolist p">
                <span>2017-01-20 11:27:41</span>
            <!--购买商品规格-->
                <!--<span></span>-->
            <!--评论者评论时间与购买时间差-->
                <!--<span>购买17186天后评价</span>-->
    ...
    <!--点赞，回复-->
        <div class="g_come">
            ...
            <a  onclick="zan(this);"  data-comment-id="331"><i class="detai-ico z-ten"></i><span id="span_zan_331" data-io="0">0</span></a>
        </div>
    </div>
    <!--回复框-->
    <!--<div class="reply-textarea">-->
        ...
        <!--<div class="inner">-->
            <!--<textarea class="reply-input J-reply-input" data-id="replytext_331" placeholder="回复 ：" maxlength="120"></textarea>-->
...
<div class="people-comment">
    <div class="deta-descri p">
        ...
        <div class="person-com">
            ...
            <div class="lifr4 p">
                <div class="dstar start5">
                   <i class="start start1" style="width:40%"></i>
                </div>
            </div>
            ...
            <!--晒单图-->
            <div class="lifr4 requiimg p">
                <ul class="comment_images" id="comment_images_133">
                                            <a><li><img data-original="/public/upload/goods/2016/03-09/56e01a54a2c6d.jpg" src="/public/upload/goods/2016/03-09/56e01a54a2c6d.jpg"/></li></a>
                                            <a><li><img data-original="/public/upload/goods/2016/03-09/56e01a54bcc53.jpg" src="/public/upload/goods/2016/03-09/56e01a54bcc53.jpg"/></li></a>
                                            <a><li><img data-original="/public/upload/goods/2016/03-09/56e01a54de5a9.jpg" src="/public/upload/goods/2016/03-09/56e01a54de5a9.jpg"/></li></a>
                                    </ul>
                <script>
                    var viewer = new Viewer(document.getElementById('comment_images_133'), {
                        url: 'data-original',
                        show: function() {
                            $('.soubao-sidebar').hide();
                        },
    ...
    <!--点赞，回复-->
        <div class="g_come">
            <a href="javascript:void(0);"><i class="detai-ico c-cen"></i>0</a>
            <a  onclick="zan(this);"  data-comment-id="133"><i class="detai-ico z-ten"></i><span id="span_zan_133" data-io="0">0</span></a>
        </div>
    </div>
    <!--回复框-->
    <!--<div class="reply-textarea">-->
        <!--<div class="reply-arrow"><b class="layer1"></b><b class="layer2"></b></div>-->
        <!--<div class="inner">-->
            <!--<textarea class="reply-input J-reply-input" data-id="replytext_133" placeholder="回复 ：" maxlength="120"></textarea>-->
            <!--<div class="operate-box">-->
                <!--<span class="txt-countdown">还可以输入<em>120</em>字</span>-->
                <!--<a class="reply-submit J-submit-reply J-submit-reply-lz" href="javascript:void(0);" target="_self">提交</a>-->
            <!--</div>-->
...
<div class="people-comment">
    <div class="deta-descri p">
        ...
        <div class="person-com">
            ...
            <!--晒单图-->
            <div class="lifr4 requiimg p">
                <ul class="comment_images" id="comment_images_67">
                                    </ul>
                <script>
                    var viewer = new Viewer(document.getElementById('comment_images_67'), {
                        url: 'data-original',
                        show: function() {
                            $('.soubao-sidebar').hide();
                        },
    ...
    <!--点赞，回复-->
        <div class="g_come">
            <a href="javascript:void(0);"><i class="detai-ico c-cen"></i>0</a>
            <a  onclick="zan(this);"  data-comment-id="67"><i class="detai-ico z-ten"></i><span id="span_zan_67" data-io="0">0</span></a>
        </div>
    </div>
    <!--回复框-->
    <!--<div class="reply-textarea">-->
        <!--<div class="reply-arrow"><b class="layer1"></b><b class="layer2"></b></div>-->
        <!--<div class="inner">-->
            <!--<textarea class="reply-input J-reply-input" data-id="replytext_67" placeholder="回复 ：" maxlength="120"></textarea>-->
            <!--<div class="operate-box">-->
                <!--<span class="txt-countdown">还可以输入<em>120</em>字</span>-->
                <!--<a class="reply-submit J-submit-reply J-submit-reply-lz" href="javascript:void(0);" target="_self">提交</a>-->
            <!--</div>-->
