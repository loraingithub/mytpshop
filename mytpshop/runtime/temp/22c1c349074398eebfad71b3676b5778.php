<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:37:"./template/pc/rainbow/user\index.html";i:1502356493;s:38:"./template/pc/rainbow/user\header.html";i:1499420874;s:36:"./template/pc/rainbow/user\menu.html";i:1501841084;s:46:"./template/pc/rainbow/public\footer_index.html";i:1501146201;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
			    	...
			    	<div class="ri-menu fr">
			    		<div class="menu-ri-t p">
			    			...
			    			<div class="mu-midd fl">
			    				...
			    				<a class="mu-m-vip"><?php if($user['is_distribut']==1): ?>经销商<?php endif; if($user['is_distribut']==0): ?>普通会员<?php endif; ?></a>
			    				<p>
			    					<span>邀请码:</span>
			    					<span>
                                        <?php echo $user['yqm']; ?>
			    				...
			    				<ul class="mu-a2">
									...
									<li>
										<a href="#">
											...
											<span>分佣金额</span>
											<em class="mu-unit">&nbsp;元</em>
											<em class="mu-num"><?php echo $user['distribut_money']; ?></em>
											<i class="icon-ar"></i>
										</a>
									</li>
			    				</ul>
