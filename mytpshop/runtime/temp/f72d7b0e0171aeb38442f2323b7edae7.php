<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:43:"./application/admin/view2/goods\_goods.html";i:1501483673;s:44:"./application/admin/view2/public\layout.html";i:1499420862;}*/ ?>
<!doctype html>
<html>
<head>
...
<!--通用信息-->
	  ...
	  <dl class="row">
        ...
        <dd class="opt">
          <div class="onoff">
            <label for="is_fx1" class="cb-enable <?php if($is_fx == 1): ?>selected<?php endif; ?>">是</label>
            <label for="is_fx0" class="cb-disable <?php if($is_fx == 0): ?>selected<?php endif; ?>">否</label>
            <input id="is_fx1" name="is_fx" value="1" type="radio" <?php if($is_fx == 1): ?> checked="checked"<?php endif; ?>>
            <input id="is_fx0" name="is_fx" value="0" type="radio" <?php if(is_fx == 0): ?> checked="checked"<?php endif; ?>>
          </div>
          <p class="notic"></p>
        </dd>
      </dl>            
