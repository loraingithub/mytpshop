<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:42:"./template/pc/rainbow/goods\goodsInfo.html";i:1502528516;s:40:"./template/pc/rainbow/public\header.html";i:1502439208;s:46:"./template/pc/rainbow/public\footer_index.html";i:1501146201;s:46:"./template/pc/rainbow/public\sidebar_cart.html";i:1499420874;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    ...
    <div class="details-bigimg p">
        <div class="w1224">
            ...
            <form id="buy_goods_form" name="buy_goods_form" method="post" >
                ...
                <br>
                <?php if($goods['is_fx']==1): ?>
                    <div class="standard p">
                    <ul>
                        <li class="jaj"><span>邀请码：&nbsp</span></li>
                        <li class="lawir"><span class="service"><input name='yqm'></span></li>
                    </ul>
                    </div>
