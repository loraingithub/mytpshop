...
return	array(	
	...
	'shop'=>array('name'=>'商城','child'=>array(
				array('name' => '商品','child' => array(
					...
					array('name' => '商品列表操作', 'act'=>'goodsListAction', 'op'=>'Goods'),
    	    ...
    	    // array('name' => '分店','child' => array(
    	    //     array('name' => '分店', 'act'=>'index', 'op'=>'Fd'),
    	    //     array('name' => '分店', 'act'=>'menu', 'op'=>'Fd'),
    	    //     array('name' => '分店', 'act'=>'text', 'op'=>'Fd'),
    	    //     //array('name' => '图文回复', 'act'=>'img', 'op'=>'Wechat'),
    	    // )),
    	    array('name' => '分店','child' => array(
   array('name' => '分店', 'act'=>'fendian', 'op'=>'Fendian'),
   /*array('name' => '分店2', 'act'=>'distributor_list', 'op'=>'Distribut'),
   array('name' => '分店3', 'act'=>'tree', 'op'=>'Distribut'),
   array('name' => '分店1', 'act'=>'set', 'op'=>'Distribut'),
   array('name' => '分成日志', 'act'=>'rebate_log', 'op'=>'Distribut'),*/
)),
